...
@Complete_Simulator_Professional2
Feature: 1003 Complete Simulator Professional 6
  Description: 
  	As a Money Experience Engineer
  	I want an automation tool to execute user choices for all TME Simulator lessons in Professional 2
