...
Feature: 1000 Step Development
  ...
  Scenario: User sets priorities at start of Lesson
    ...
    #		And a user selects the "Career Change" Optional Narrative from the Dashboard
...
#And a user selects the "401k" Optional Narrative from the Dashboard
# And a user selects the "529" Optional Narrative from the Dashboard
#And a user selects the "Change Residence" Optional Narrative from the Dashboard
And a user selects the "Make an Investment" Optional Narrative from the Dashboard
